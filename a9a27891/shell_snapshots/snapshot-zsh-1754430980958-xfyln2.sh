...
alias -- run-help=man
alias -- sync-full='python3 ~/claude-sync-extended.py sync --level full'
alias -- sync-pull='python3 ~/claude-sync-extended.py pull'
alias -- sync-pull-full='python3 ~/claude-sync-extended.py pull --level full'
alias -- sync-push='python3 ~/claude-sync-extended.py push'
alias -- sync-push-full='python3 ~/claude-sync-extended.py push --level full'
alias -- sync-status='python3 ~/claude-sync-extended.py status'
alias -- which-command=whence
# Check for rg availability
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/Users/davide/.nvm/versions/node/v22.17.1/lib/node_modules/\@anthropic-ai/claude-code/vendor/ripgrep/arm64-darwin/rg'
fi
export PATH='/Users/davide/.nvm/versions/node/v22.17.1/bin:/Users/davide/.bun/bin:/Users/davide/.local/bin:/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin:/Applications/Little Snitch.app/Contents/Components:/Users/davide/.cargo/bin:/Applications/iTerm.app/Contents/Resources/utilities:/Users/davide/.lmstudio/bin'
